...
urlpatterns = [
    ...
    path('dashboard/professeur/cours/module/modify/<int:pk>/', views.modify_module, name="modify_module"),
    path('dashboard/professeur/cours/module/delete/<int:pk>/', views.delete_module, name="delete_module")
]